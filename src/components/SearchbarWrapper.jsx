...
export default function SearchbarWrapper() {
    ...
    const Search = () => {
        const queryParams = { searchValue, maxCalories, mealType, dietType };
        const APIcallstring = QueryBuilder(queryParams) ;
    ...
    return(
        ...
        <MainContainer>
            <SearchContainer>
                <Searchbar type="search" placeholder="What would you like to cook today?"
                           value={searchValue}
            ...
            <CriteriaContainer>
                ...
                <CriteriaItem>
                    ...
                    <Input type="number" id="maxCalories" name="maxCalories" placeholder="optional number e.g. 300"
                           value={maxCalories}
                ...
                <CriteriaItem>
                    ...
                    <Input type="string" id="DietType" name="DietType" placeholder="e.g Vegetarian"
                           value={dietType}
                ...
                <CriteriaItem>
                    ...
                    <Input type="text" id="mealType" name="mealType" placeholder="e.g., Dinner"
                    value={mealType}
